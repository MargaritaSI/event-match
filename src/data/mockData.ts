...
export const MOCK_USERS: User[] = [
  { id: '1', name: 'Alex Carter', role: 'Founder', company: 'Lexi AI', bio: 'Building an AI writing tool with TypeScript & Python. Looking for UX help and early users.', interests: ['ai', 'startup', 'design'], intents: ['cofounder', 'hiring'], hobbies: ['Chess', 'Bouldering'], lookingFor: 'A UX designer for design feedback', canHelp: 'Fundraising, LLM product strategy, Python', speaker: true, speakerTopic: 'From idea to AI product in 6 weeks', socials: { twitter: '@alex_founder', linkedin: 'alex-carter' }, event: EVENT, photoColor: G[0] },
  { id: '2', name: 'Maya Bennett', role: 'UX Designer', company: 'Figma', bio: 'Design systems & accessibility. Into web design and graphic design. Yoga and running.', interests: ['design', 'sport', 'frontend'], intents: ['job', 'learning'], hobbies: ['Yoga', 'Pottery', 'Running'], lookingFor: 'Frontend dev to bring a design system to life', canHelp: 'Figma, UI/UX, graphic design, accessibility', speaker: true, speakerTopic: 'Design systems that scale', socials: { twitter: '@maya_ux', instagram: '@maya.design' }, event: EVENT, photoColor: G[1] },
  { id: '3', name: 'Olivia Reed', role: 'Tech Recruiter', company: 'HireLoop', bio: 'I connect engineers with great teams and run networking events.', interests: ['networking', 'startup', 'business'], intents: ['hiring'], hobbies: ['Travel', 'Wine tasting'], lookingFor: 'Senior React & mobile engineers who are hiring-curious', canHelp: 'Intros, salary benchmarks, CV review', socials: { linkedin: 'olivia-reed', twitter: '@olivia_hr' }, event: EVENT, photoColor: G[2] },
  { id: '4', name: 'Liam Walsh', role: 'iOS Developer', company: 'Focusly', bio: 'I build focus and habit apps with Swift. Drummer and cyclist.', interests: ['mobile', 'health', 'ai'], intents: ['cofounder', 'learning'], hobbies: ['Drumming', 'Cycling'], lookingFor: 'Someone to swap productivity systems with', canHelp: 'Swift, Core Data, on-device ML', socials: { twitter: '@liam_ios', instagram: '@liam.code' }, event: EVENT, photoColor: G[3] },
  { id: '5', name: 'Sara Lindqvist', role: 'Running Coach', company: 'RunWell', bio: 'I write about healthy living and coach runners on the side.', interests: ['sport', 'health', 'travel'], intents: ['clients', 'mentor'], hobbies: ['Marathon', 'Running', 'Cooking'], lookingFor: 'A dev to build a simple training-log app with me', canHelp: 'Training plans, content, community building', socials: { instagram: '@sara.run', twitter: '@sara_sport' }, event: EVENT, photoColor: G[4] },
  { id: '6', name: 'Tom Bakker', role: 'Frontend Engineer', company: 'Vercel', bio: 'React & TypeScript nerd. Amsterdam local, happy to show people around.', interests: ['design', 'frontend', 'travel'], intents: ['job', 'cofounder'], hobbies: ['Photography', 'Board games', 'Football'], lookingFor: 'Hackathon teammates for a fun weekend build', canHelp: 'React, JavaScript, animations, local tips', speaker: true, speakerTopic: 'Edge rendering with React', socials: { twitter: '@tombakker', linkedin: 'tom-bakker' }, event: EVENT, photoColor: G[5] },
  { id: '7', name: 'Priya Sharma', role: 'ML Engineer', company: 'Cloudflare', bio: 'Work on recommendation systems in Python. Curious about health & wearables data.', interests: ['ai', 'health', 'data'], intents: ['job', 'learning'], hobbies: ['Climbing', 'Reading'], lookingFor: 'People building in health-tech with real data', canHelp: 'ML pipelines, data science, Python', speaker: true, speakerTopic: 'Recommenders at the edge', socials: { linkedin: 'priya-sharma', twitter: '@priya_ml' }, event: EVENT, photoColor: G[6] },
  { id: '8', name: 'Marco Rossi', role: 'Startup Founder', company: 'PayLoop', bio: 'Second-time founder in fintech. Always up for a coffee chat.', interests: ['startup', 'networking', 'ai'], intents: ['cofounder', 'invest'], hobbies: ['Espresso', 'Running'], lookingFor: 'A technical co-founder for a new idea', canHelp: 'Go-to-market, sales, hiring', socials: { linkedin: 'marco-rossi', twitter: '@marco_r' }, event: EVENT, photoColor: G[7] },
  { id: '9', name: 'Yuki Tanaka', role: 'Mobile Developer', company: 'Picnic', bio: 'Flutter & React Native in Dart & Kotlin. Love cross-platform tricks. Surfer.', interests: ['mobile', 'startup', 'travel'], hobbies: ['Anime', 'Surfing'], lookingFor: 'Flutter devs to compare notes with', canHelp: 'Flutter, Dart, Kotlin, app performance', socials: { twitter: '@yuki_dev', instagram: '@yuki.codes' }, event: EVENT, photoColor: G[8] },
  { id: '10', name: 'Emma Wilson', role: 'Product Manager', company: 'Calm', bio: 'PM in wellness apps. Into calm, focused UX. Hiker.', interests: ['health', 'business', 'design'], hobbies: ['Hiking', 'Journaling'], lookingFor: 'Designers & devs in the wellness space', canHelp: 'Product discovery, user research', socials: { linkedin: 'emma-wilson', twitter: '@emma_pm' }, event: EVENT, photoColor: G[9] },
  { id: '11', name: 'Jonas Hoffmann', role: 'Backend Engineer', company: 'GitLab', bio: 'Node & Go. I build APIs that scale and mentor juniors. Climber.', interests: ['backend', 'startup', 'networking'], hobbies: ['Climbing', 'Brewing'], lookingFor: 'A frontend partner for a hackathon project', canHelp: 'Go, Node.js, backend architecture, DevOps', socials: { twitter: '@jonas_be', linkedin: 'jonas-h' }, event: EVENT, photoColor: G[0] },
  { id: '12', name: 'Sofia Garcia', role: 'Designer & Illustrator', company: 'Studio Forma', bio: 'Brand and graphic design. I draw conference sketchnotes for fun.', interests: ['design', 'travel', 'networking'], hobbies: ['Illustration', 'Salsa'], lookingFor: 'Founders who need a brand identity', canHelp: 'Branding, graphic design, illustration', socials: { instagram: '@sofia.draws', twitter: '@sofia_g' }, event: EVENT, photoColor: G[1] },
  { id: '13', name: 'Noah Bell', role: 'Developer Advocate', company: 'Sentry', bio: 'Developer advocate. I love connecting people and giving talks. Tennis player.', interests: ['networking', 'ai', 'startup'], hobbies: ['Public speaking', 'Tennis'], lookingFor: 'Interesting projects to feature in talks', canHelp: 'Talks, community, content, intros', speaker: true, speakerTopic: 'Pitching your project to judges', socials: { twitter: '@noah_devrel', linkedin: 'noah-bell' }, event: EVENT, photoColor: G[2] },
  { id: '14', name: 'Anna Petersen', role: 'Data Scientist', company: 'Whoop', bio: 'Health analytics in Python & R. I track sleep, HRV, mood. Swimmer.', interests: ['health', 'data', 'sport'], hobbies: ['Quantified self', 'Swimming'], lookingFor: 'Health-data nerds to geek out with', canHelp: 'Stats, data viz, Python, wearable APIs', socials: { linkedin: 'anna-petersen', twitter: '@anna_data' }, event: EVENT, photoColor: G[3] },
  { id: '15', name: 'Ravi Patel', role: 'Fullstack Dev', company: 'Freelance', bio: 'I ship side-projects fast in JavaScript. Looking for accountability buddies. Cricket fan.', interests: ['startup', 'frontend', 'ai'], hobbies: ['Cricket', 'Cooking'], lookingFor: 'An accountability partner', canHelp: 'JavaScript, fullstack, Supabase, rapid prototyping', socials: { twitter: '@ravi_builds', instagram: '@ravi.dev' }, event: EVENT, photoColor: G[4] },
  { id: '16', name: 'Julia Moreau', role: 'Frontend Lead', company: 'Nx', bio: 'Lead a React team. Passionate about DX and mentoring. Rock climber.', interests: ['frontend', 'startup', 'networking'], hobbies: ['Rock climbing', 'Baking'], lookingFor: 'Engineers who care about developer experience', canHelp: 'React, TypeScript, team leadership', socials: { linkedin: 'julia-moreau', twitter: '@julia_fe' }, event: EVENT, photoColor: G[5] },
  { id: '17', name: 'Daniel Kim', role: 'Indie Hacker', company: 'Solo', bio: 'Bootstrapped two micro-SaaS. Love talking pricing and growth.', interests: ['startup', 'ai', 'business'], hobbies: ['Travel', 'Photography'], lookingFor: 'Other indie hackers to share numbers with', canHelp: 'SaaS pricing, SEO, solo founder life', socials: { twitter: '@danielkim', linkedin: 'daniel-kim' }, event: EVENT, photoColor: G[6] },
  { id: '18', name: 'Mia Andersen', role: 'Accessibility Engineer', company: 'Spotify', bio: 'I make the web usable for everyone. Big on inclusive web design.', interests: ['design', 'frontend', 'networking'], hobbies: ['Sign language', 'Gardening'], lookingFor: 'Teams who want an a11y audit', canHelp: 'WCAG, screen readers, inclusive UX', socials: { linkedin: 'mia-andersen', twitter: '@mia_a11y' }, event: EVENT, photoColor: G[7] },
  { id: '19', name: 'Carlos Mendez', role: 'Game Developer', company: 'Pixel Forge', bio: 'Unity & C# web games. Exploring gamification for health apps.', interests: ['gamedev', 'health', 'startup'], hobbies: ['Gaming', 'Guitar'], lookingFor: 'Health founders curious about gamification', canHelp: 'Game design, C#, animation', socials: { twitter: '@carlos_games', instagram: '@carlos.makes' }, event: EVENT, photoColor: G[8] },
  { id: '20', name: 'Nina Larsen', role: 'Founder', company: 'CycleSync', bio: 'Building a cycle + sleep tracker. Looking for iOS help! Pilates fan.', interests: ['health', 'startup', 'design'], intents: ['cofounder', 'hiring'], hobbies: ['Pilates', 'Tea'], lookingFor: 'An iOS dev who knows HealthKit', canHelp: 'Health domain expertise, product vision', socials: { linkedin: 'nina-larsen', twitter: '@nina_wellness' }, event: EVENT, photoColor: G[9] },
  { id: '21', name: 'Victoria Hale', role: 'Partner', company: 'Northstar Ventures', bio: 'Early-stage VC investing in dev tools and health-tech. Always meeting founders.', interests: ['business', 'startup', 'ai'], intents: ['invest'], hobbies: ['Sailing', 'Opera'], lookingFor: 'Pre-seed & seed founders in dev tools / health', canHelp: 'Fundraising, intros to investors, GTM', socials: { linkedin: 'victoria-hale', twitter: '@victoria_vc' }, event: EVENT, photoColor: G[0] },
  { id: '22', name: 'Hana Suzuki', role: 'HCI Researcher', company: 'TU Delft', bio: 'I study attention & focus and design research. Runner.', interests: ['health', 'design', 'data'], hobbies: ['Calligraphy', 'Running'], lookingFor: 'App builders to interview', canHelp: 'User research, study design', speaker: true, speakerTopic: 'Designing for focus', socials: { linkedin: 'hana-suzuki', twitter: '@hana_hci' }, event: EVENT, photoColor: G[1] },
  { id: '23', name: 'Felix Weber', role: 'Freelance Dev', company: 'Freelance', bio: 'React & Node in JavaScript for hire. Between projects, looking to collaborate. Skier.', interests: ['frontend', 'backend', 'travel'], hobbies: ['Skiing', 'Cooking'], lookingFor: 'A co-founder or a fun contract', canHelp: 'JavaScript, fullstack, MVPs, code review', socials: { twitter: '@felix_dev', linkedin: 'felix-weber' }, event: EVENT, photoColor: G[2] },
  { id: '24', name: 'Zara Ahmed', role: 'Product Designer', company: 'Linear', bio: 'I design calm, focused interfaces. Into UI/UX and motion design.', interests: ['design', 'frontend', 'health'], hobbies: ['Knitting', 'Climbing'], lookingFor: 'Devs to build calm, focused tools with', canHelp: 'UI/UX, design systems, prototyping', socials: { instagram: '@zara.designs', twitter: '@zara_ux' }, event: EVENT, photoColor: G[3] },
  { id: '25', name: 'Erik Lund', role: 'Engineering Manager', company: 'Klarna', bio: 'I grow happy teams. Interested in remote culture and async. Hiker.', interests: ['networking', 'business', 'travel'], intents: ['hiring', 'mentor'], hobbies: ['Hiking', 'Photography'], lookingFor: 'ICs interested in management, or great culture stories', canHelp: 'Career advice, 1:1 coaching, team building', socials: { linkedin: 'erik-lund', twitter: '@erik_em' }, event: EVENT, photoColor: G[4] },
];
