...
const make = (
  ...
  map: { title: navMap, subtitle: 'DevConnect 2026', entrance: 'Entrance', registration: 'Registration', workingZone: 'Working Zone', mainStage: 'Web Engineering Track', wc: 'WC', coffee: 'Coffee', food: 'Food', hackathon: 'Hackathon Zone', legend: 'Legend' },
  ...
  sponsors: { title: navSponsors, subtitle: 'DevConnect 2026', forYou: 'Recommended', booth: 'Booth', website: 'Website', hiring: '🔥 Hiring' },
